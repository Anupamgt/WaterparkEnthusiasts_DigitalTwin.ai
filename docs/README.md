...
- [WALKTHROUGH.md](WALKTHROUGH.md) — click script for the Ops demo recording.
- Round 2 walkthrough video: `demo.mp4` in this folder (Ops: supervisor HITL, manager window queue, leadership go/no-go).
